...
if ($jarak < 0.2) {
    ...
    if ($aksi == "tap_in") {
        $koneksi->query("INSERT INTO absensi (nama, tanggal, jam_masuk) VALUES ('$user', '$tanggal', '$jam')");
    } else {
        $koneksi->query("UPDATE absensi SET jam_pulang='$jam' WHERE nama='$user' AND tanggal='$tanggal'");
    }
